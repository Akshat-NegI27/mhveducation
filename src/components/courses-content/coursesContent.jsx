  ...
  return (
    <div className="courses-container">
      <SEO
        ...
        description="Explore MHV Education’s top stock market courses in Dehradun, including Technical Analysis, Intraday, Elliott Wave, and CMT—taught by expert mentors."
